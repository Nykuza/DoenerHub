...
public class MainWindow {
    ...
    private void addNewLaden() {
        ...
        try {
            orte.addLaden(new doener_verwaltung.model.Laeden(name, adresse));
    ...
    private void deleteLaden() {
        ...
        doener_verwaltung.model.Laeden laden = orte.getAllLaeden().get(index);
    ...
    private void addNewSpeise() {
        ...
        try {
            orte.addSpeise(new Speisen(name, preis, kategorie));
    ...
    private void addNewGetraenk() {
        ...
        try {
            orte.addGetraenk(new Getraenke(name, preis, groesse));
    ...
    private void initializeExampleData() {
        try {
            // Läden
            orte.addLaden(new doener_verwaltung.model.Laeden("Döner Palace", "Main Str. 5"));
            orte.addLaden(new doener_verwaltung.model.Laeden("Kebab King", "Station Platz 12"));
